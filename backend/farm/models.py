...
class Farm(models.Model):
    ...
    name = models.CharField(
        max_length=100, help_text=_("Nombre de la finca"), verbose_name=_("Nombre")
    )
    address = models.CharField(
        max_length=255, help_text=_("Dirección de la finca"), verbose_name=_("Dirección")
    )
...
class Plot(models.Model):
    ...
    name = models.CharField(
        max_length=100, help_text=_("Nombre del lote"), verbose_name=_("Nombre")
    )
    description = models.TextField(
        blank=True, help_text=_("Descripción del lote"), verbose_name=_("Descripción")
    )
    ...
    centroid = gis_models.PointField(
        blank=True, null=True, help_text=_("Centroide del lote"), verbose_name=_("Centroide")
    )
