...
class Farmer(models.Model):
    ...
    is_active = models.BooleanField(
        default=True, help_text=_("Indica si el agricultor está activo"), verbose_name=_("Activo")
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text=_("Fecha de creación del agricultor")
    )
    updated_at = models.DateTimeField(
        auto_now=True, help_text=_("Fecha de actualización del agricultor")
    )
...
class Organization(models.Model):
    name = models.CharField(
        max_length=100, null=True, blank=True, help_text=_("Nombre de la organización")
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text=_("Fecha de creación de la organización")
    )
    updated_at = models.DateTimeField(
        auto_now=True, help_text=_("Fecha de actualización de la organización")
    )
    panels = [
        MultiFieldPanel(
            [
